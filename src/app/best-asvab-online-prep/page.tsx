    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <section className="mb-10">
        ...
        <div className="space-y-2">
          {[
            { label: "Price", desc: "Monthly and annual cost. Cheaper wins, all else equal." },
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 text-sm text-text-secondary">
          $9.99/mo &middot; $49.99/yr (save 58%)
        </p>
          ...
          {[
            {
              ...
              rec: "ASVAB Hero Pro at $9.99/mo. Start with the free diagnostic to see where you stand.",
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              a: "UnionTestPrep is completely free. Among paid options with score tracking, ASVAB Hero Pro at $9.99/month is the lowest-cost entry point. At $49.99/year, that drops to $4.17/month.",
            },
            {
