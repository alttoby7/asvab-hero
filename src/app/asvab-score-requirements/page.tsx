...
export const metadata: Metadata = {
  title: "ASVAB Score Requirements by Branch (2026) | ASVAB Hero",
  description:
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "The Army requires a minimum AFQT of 31 with a high school diploma or 50 with a GED. Specific jobs have separate composite requirements. For example, Intelligence Analyst (35F) needs ST 101 and GT 107. Infantry (11B) requires CO 87.",
              },
            },
            {
              "@type": "Question",
      ...
      <article className="prose-asvab">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                ...
                <td className="py-2">
                  Above average. Most jobs open. Some bonus eligibility
                  depending on branch and MOS.
                </td>
              </tr>
              <tr className="border-b border-navy-border/50">
        ...
        <p className="text-text-secondary">
          The jump from Category IIIB to IIIA at the 50-point mark is the single
          biggest quality-of-life threshold in the enlistment process. Below 50,
          your options narrow and recruiters have less incentive to work with you
          on job selection. Above 50, you unlock the majority of available MOSs
          and become eligible for enlistment bonuses that can exceed $50,000 in
          high-demand fields.
        </p>
        <p className="text-text-secondary">
        ...
        <p className="mt-4 text-text-secondary">
          <strong>Army:</strong> 10 line scores (GT, CL, CO, EL, FA, GM, MM, OF,
          SC, ST). Each combines 2&ndash;4 subtests. GT (VE + AR) is the most
          referenced for intelligence, technical, and leadership MOSs. CL (VE +
          AR + MK) covers administrative and clerical roles. CO (AR + AS + MC)
          gates combat positions. See the full{" "}
        ...
        <div className="my-4 space-y-2">
          ...
          <div className="rounded-lg bg-navy px-4 py-3">
            <p className="font-mono text-sm font-bold text-accent">Cost</p>
            <p className="mt-1 text-sm text-text-secondary">
              Free (Army-funded)
            </p>
          </div>
          <div className="rounded-lg bg-navy px-4 py-3">
            <p className="font-mono text-sm font-bold text-accent">
              Average GT improvement
            </p>
            <p className="mt-1 text-sm text-text-secondary">19 points</p>
          </div>
          <div className="rounded-lg bg-navy px-4 py-3">
            <p className="font-mono text-sm font-bold text-accent">
              Success rate
        ...
        <aside className="my-6 rounded-lg border-l-4 border-emerald-400 bg-navy p-4">
          <p className="text-sm font-semibold text-emerald-400">Tip</p>
          <p className="mt-1 text-sm text-text-secondary">
            Do not study all 9 subtests equally. Identify your 2&ndash;3
            weakest AFQT subtests first, then target the composites for your
            desired job. Take a{" "}
        ...
        <p className="text-text-secondary">
          ...
          baseline, focus your study time on verbal skills (the highest-leverage
          subtests), and use the <Link href="/calculator">calculator</Link> to
          track which jobs open as your scores improve. If you have a GED, look
          into the 15-credit Tier I reclassification before assuming you need a
          50.
        </p>
        <p className="text-text-secondary">
        ...
        <div className="mt-4 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              ...
              you as Tier I, dropping your requirement to diploma-level
              minimums.
            </p>
          </div>
          <div>
