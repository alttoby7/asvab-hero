      ...
      <article className="prose-asvab">
        ...
        <div className="my-4 space-y-3">
          {[
            ...
            { label: "AFQT Minimums", desc: "The Army requires the lowest AFQT score of any active branch: 31. Marines require 32. Navy requires 31. Air Force and Space Force require 36. Coast Guard requires 32." },
