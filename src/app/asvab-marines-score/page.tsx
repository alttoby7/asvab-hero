    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <article className="prose-asvab">
        ...
        <p className="text-text-secondary">
          ...
          AFQT for diploma holders. Some third-party sources cite 32, referencing
          MCO 1230.5C from 2014. Others cite 35. The 31 figure from marines.com
          is the authoritative current number.
        </p>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                ...
                <td className="py-2 pr-4">
                  0321 Recon Marine, 0317 Scout Sniper, 267x Linguist MOSs, 0842
        ...
        <aside className="my-6 rounded-lg border-l-4 border-amber-400 bg-navy p-4">
          ...
          <p className="mt-1 text-sm text-text-secondary">
            ...
            choosing from the narrowest slice of the Marine Corps. A 30-day study
            push to raise your GT above 100 opens a fundamentally different set
            of career paths.
          </p>
        </aside>
        ...
        {/* ── Recon, MARSOC, and Special Operations ── */}
        <h2 className="mt-12 font-display text-2xl font-bold text-text-primary">
        ...
        <ol className="my-4 list-decimal space-y-2 pl-6 text-text-secondary">
          ...
          <li>
            Ground Reconnaissance Course (9 weeks): land navigation, demolitions,
            call-for-fire, comms, live-fire, patrol phase
          </li>
          <li>
        ...
        <p className="text-text-secondary">
          ...
          capstone exercise. After ITC, expect Basic Airborne Course and 6 months
        ...
        <p className="text-text-secondary">
          The most common use case: a Marine with GT 98 who wants to lateral move
          to 0321 Reconnaissance Marine (GT 105 required). The Recon lateral move
          policy explicitly encourages Marines below GT 105 to retake via AFCT.
          Your command already expects this request.
        </p>
        ...
        <div className="mt-4 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              ...
              thresholds in the Marine Corps. Most recruits who clear the 31 AFQT
              minimum will still need solid AR and verbal scores to reach GT 80.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              ...
              the <Link href="/gt-score-calculator">GT score calculator</Link>{" "}
              for details.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              ...
              a command authorization letter. Schedule through Education Services.
              New scores replace your old scores within 14 to 30 days and apply
              to MOS qualification immediately. The{" "}
