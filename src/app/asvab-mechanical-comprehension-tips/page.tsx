    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <article className="prose-asvab">
        ...
        <p className="text-text-secondary">
          ...
          Force at 36; Coast Guard at 32. MC prep doesn&apos;t move that number
          at all.
        </p>
