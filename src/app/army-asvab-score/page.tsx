  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <article className="prose-asvab">
        ...
        <div className="my-4 overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                <td className="py-2 pr-4 font-semibold text-text-primary" colSpan={3}>Intelligence and Cyber</td>
              </tr>
              <tr className="border-b border-navy-border/50">
              ...
              {/* Admin and Support */}
              <tr className="border-b border-navy-border/50">
                <td className="py-2 pr-4 font-semibold text-text-primary" colSpan={3}>Admin and Support</td>
              </tr>
              <tr className="border-b border-navy-border/50">
              ...
              <tr>
                <td className="py-2 pr-4 font-semibold text-text-primary">74B</td>
        ...
        {/* ── Email Capture ── */}
        <EmailCapture
          headline="Want to see which Army MOS you qualify for?"
          subhead="Free 6-page study plan plus a 5-email crash course covering AFQT, line scores, and the subtests that move your Army composites."
