...
export const metadata: Metadata = {
  title:
    "Navy ASVAB Score Requirements 2026: Ratings, Nuclear, SEAL | ASVAB Hero",
  description:
    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <article className="prose-asvab">
        ...
        <p className="text-text-secondary">
          Your <strong>navy ASVAB score</strong> works as a two-gate system.
          Gate one: your AFQT percentile determines whether you can enlist. Gate
          two: your subtest score combinations determine which rating you get.
          The Navy&apos;s composite system is unlike every other branch. No
          named line scores like the Army&apos;s GT or the Air Force&apos;s
          MAGE. Each rating has its own formula, and many offer two or three
          alternative paths to qualify.
        </p>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                ...
                <td className="py-2 font-mono">AR+MK+EI+VE &gt;= 221</td>
              </tr>
              <tr>
                <td className="py-2 pr-4 font-semibold text-text-primary">
                  ST
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                ...
                <td className="py-2 font-mono">VE+AR &gt;= 96</td>
              </tr>
              <tr className="border-b border-navy-border/50">
                <td className="py-2 pr-4 font-semibold text-text-primary">
                  PS
              ...
              <tr>
                ...
                <td className="py-2 font-mono">VE+AR+MK+GS &gt;= 215</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-navy-border/50">
                ...
                <td className="py-2">No line score minimum (AFQT only)</td>
              </tr>
              <tr className="border-b border-navy-border/50">
                <td className="py-2 pr-4 font-semibold text-text-primary">
                  CS
                ...
                <td className="py-2 font-mono">VE+AR &gt;= 82</td>
              </tr>
              <tr>
                <td className="py-2 pr-4 font-semibold text-text-primary">
                  ABE
                ...
                <td className="py-2 font-mono">VE+AR+MK+AS &gt;= 184</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mt-12 rounded-2xl border border-navy-border bg-navy-light p-6 text-center">
          ...
          <p className="mt-2 text-sm text-text-secondary">
            ...
            scores, and every Navy rating you qualify for.
          </p>
          <Link
            href="/calculator"
