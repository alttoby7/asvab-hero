...
- **Stripe** LIVE in production. Plans (2026-06-30): Annual $49.99/yr (default/best-value), Monthly $14.99/mo + 7-day card-required trial, one-time 90-Day Pass $39. Retaker tier RETIRED (never sold; product archived). Old $24.99/mo + $59 pass + $9.99 prices archived; grandfathered subs keep their rate. Price ids + archive log: `apps/web/CONTINUITY-2026-06-30-pricing-14-99-pass-39.md`. Functions: `stripe-checkout`, `stripe-portal`, `stripe-webhook`.
- **PRICING FREEZE until 2026-07-29.** Do NOT change prices, Stripe secrets, default tiers, or the pricing ladder. Four changes in two weeks (6/17–6/30) prevented measurement. The current lineup must hold for a full 4-week window. Details: `apps/web/CONTINUITY-2026-07-01-cro-trial-led-funnel.md`.
...
- ~~Missing calculator pages~~ DONE (verified 2026-06-12): `/marines-asvab-calculator`, `/coast-guard-asvab-calculator`, `/space-force-asvab-calculator` all exist and are in the sitemap.
