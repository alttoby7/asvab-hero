...
worked_examples:
  - prompt: |
      ...
      (A) All soldiers are trained for arctic conditions.
  ...
  - prompt: |
      ...
      (A) Weekend hours were the only reason checkouts increased.
      (B) Service members had wanted weekend library access.
      (C) The library has more books than it used to.
      (D) Checkouts will continue to increase each month.
    solution: "A and D go beyond what the data shows. C isn't in the passage. B is the logical implication: if checkouts jumped 40% once the library opened weekends, demand for those hours existed. Answer: B"
---
