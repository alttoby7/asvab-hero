...
worked_examples:
  - prompt: "Solve for x: 3x − 7 = 14"
    solution: "Add 7 to both sides: 3x = 21. Divide both sides by 3: x = 7"
  - prompt: "Solve for x: 2(x + 5) = 24"
    solution: "Distribute: 2x + 10 = 24. Subtract 10: 2x = 14. Divide by 2: x = 7"
  - prompt: "If 4x + 3 = 2x + 11, what is x?"
    solution: "Subtract 2x from both sides: 2x + 3 = 11. Subtract 3: 2x = 8. Divide by 2: x = 4"
  - prompt: "A line has equation y = 2x − 5. What is the y-value when x = 4?"
    solution: "y = 2(4) − 5 = 8 − 5 = 3"
---
