...
const pages = [
  ...
  { path: "/army-warrant-officer-requirements", priority: "0.8", changefreq: "monthly" },
  ...
  { path: "/calculate-gt-score", priority: "0.8", changefreq: "monthly" },
  { path: "/gt-score-max", priority: "0.8", changefreq: "monthly" },
