...
const pages = [
  ...
  { path: "/air-force-asvab-score", priority: "0.9", changefreq: "monthly" },
  { path: "/army-asvab-score", priority: "0.9", changefreq: "monthly" },
  { path: "/asvab-marines-score", priority: "0.9", changefreq: "monthly" },
  { path: "/coast-guard-asvab-score", priority: "0.9", changefreq: "monthly" },
  { path: "/navy-asvab-score-requirements", priority: "0.9", changefreq: "monthly" },
];
