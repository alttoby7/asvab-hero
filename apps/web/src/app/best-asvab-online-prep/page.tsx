  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        data={{
          ...
          mainEntity: [
            ...
            },
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "UnionTestPrep is completely free and covers all ASVAB subtests with a large question bank, no account required. Among paid options, ASVAB Hero Pro is the best value, a one-time 90-Day Pass for $39 (or $14.99/month) with score tracking and unlimited practice.",
              },
            },
            {
              "@type": "Question",
      ...
      <section className="mb-10">
        ...
        <p className="mb-4 text-text-secondary leading-relaxed">
          Anyone doing self-directed prep who wants unlimited practice and wants to know exactly which topics to focus on. The 90-Day Pass covers a full study window for $39 with nothing to cancel; if your test is close, a single month at $14.99 can be enough to drill hard and go.
        </p>
...
, no affiliate link)
      ...
      <section className="mb-10">
        ...
        <p className="text-text-secondary leading-relaxed">
          Budget-only students. Also useful as a supplemental question source alongside a paid platform that handles your progress tracking. If you can stretch to a $39 pass (or $14.99/month), the tracking features in Pro are worth it.
        </p>
      </section>
          ...
          {[
            {
              ...
              rec: "ASVAB Hero Pro, a $39 90-Day Pass or $14.99/mo. Start with the free diagnostic to see where you stand.",
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              a: "UnionTestPrep is completely free. Among paid options with score tracking, ASVAB Hero Pro is the best value, a one-time 90-Day Pass for $39 covers a full study window with nothing to cancel, or you can go month-to-month at $14.99.",
            },
            {
