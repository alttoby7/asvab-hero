...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Aviation Survival Technician (AST) requires a combined VE+AR+MK+MC score of 162 or higher, plus an AFQT of at least 65. AST also has demanding physical fitness requirements beyond the ASVAB. It is one of the most competitive ratings in any branch.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. The standard retake schedule is 1 month after your first test, 1 month after your second, then 6 months between each attempt after that. Active-duty members retake through the AFCT rather than the standard ASVAB. Your newest score replaces all previous scores.",
      },
    },
    {
      "@type": "Question",
      name: "What is a good ASVAB score for the Coast Guard?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "An AFQT of 50+ makes you competitive for enlistment. Scoring 65+ opens specialized ratings like AST (Rescue Swimmer) and ET (Electronics Technician). For officer programs, you need a GT score of 109 or higher.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "The Coast Guard uses sums of individual subtest standard scores instead of named composite scores like the Army's GT, CL, or ST. Each rating has its own subtest formula. The CG also has the fewest ratings (about 24 vs. 150+ Army MOSs), so qualification thresholds tend to be well-documented.",
      },
    },
  ],
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <article className="prose-asvab">
        ...
        <section className="my-8 not-prose">
          <EmailCapture
            headline="Want a study plan built for Coast Guard ratings?"
            subhead="Free 6-page PDF plus a 5-email crash course on AFQT, line scores, and which subtests matter most for the CG."
            cta="Email me the plan"
            tag="coast-guard-asvab-score"
          />
        </section>
        ...
        <aside className="my-6 rounded-lg border-l-4 border-accent bg-navy p-4">
          <p className="text-sm font-semibold text-text-primary">Key Point</p>
          <p className="mt-1 text-sm text-text-secondary">
            AR (Arithmetic Reasoning) and VE (Verbal Expression) appear in
            nearly every rating formula. These two subtests should be your top
            study priorities if you&apos;re targeting the Coast Guard.
          </p>
        </aside>
        ...
        <div className="my-3 rounded-lg bg-navy p-3 font-mono text-sm text-text-primary">
          <p>
            52 + 55 = <strong>107</strong>
          </p>
          <p className="mt-1 text-text-tertiary">Qualifies.</p>
        </div>
        ...
        <div className="my-3 rounded-lg bg-navy p-3 font-mono text-sm text-text-primary">
          <p>
            52 + 48 = <strong>100</strong>
          </p>
          <p className="mt-1 text-text-tertiary">
            Needs 154. Does not qualify. HS has one of the highest two-subtest
            thresholds in the Coast Guard.
          </p>
        </div>

        <p className="text-text-secondary">
          Jordan qualifies for 15 of the 24 ratings based on these scores. The
          three misses above show the range: AMT is close (8 points short),
          while HS requires a fundamentally different score profile.
        </p>
        ...
        <p className="text-text-secondary">
          ...
          SAT score of 1,100 (combined verbal and math) or an ACT score of 23.
        ...
        {/* Section: Which Subtests to Study */}
        <h2 className="mt-12 font-display text-2xl font-bold text-text-primary">
        ...
        <div className="mt-4 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-secondary">
              Aviation Survival Technician (AST) requires a combined
              VE+AR+MK+MC score of 162 or higher, plus an AFQT of at least 65.
              AST also has demanding physical fitness requirements beyond the
              ASVAB. It&apos;s one of the most competitive ratings in any branch.
            </p>
          </div>
          <div>
            <h3 className="font-display text-base font-bold text-text-primary">
        ...
        <div className="mt-12 rounded-2xl border border-navy-border bg-navy-light p-6 text-center">
          ...
          <p className="mt-2 text-sm text-text-secondary">
            ...
            scores, and every Coast Guard rating you qualify for.
          </p>
          <Link
            href="/calculator"
