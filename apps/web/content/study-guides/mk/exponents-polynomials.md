...
worked_examples:
  ...
  - prompt: "Simplify: (2x²)³"
    solution: "Apply power rule to each factor: 2³ × x²ˣ³ = 8x⁶"
  - prompt: "What is 5⁰?"
    solution: "Any nonzero number to the zero power equals 1. Answer: 1"
  - prompt: "Expand: (x + 3)(x − 2)"
    solution: "FOIL: First: x², Outer: −2x, Inner: 3x, Last: −6. Combine: x² + x − 6"
---
