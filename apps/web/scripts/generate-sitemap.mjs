...
const pages = [
  ...
  { path: "/asvab-assembling-objects-tips", priority: "0.8", changefreq: "monthly" },
  { path: "/afqt-vs-asvab", priority: "0.9", changefreq: "monthly" },
  { path: "/afct-vs-asvab", priority: "0.8", changefreq: "monthly" },
